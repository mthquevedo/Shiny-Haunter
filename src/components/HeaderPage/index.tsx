...
export function HeaderPage() {
    return (
        <div className="flex gap-4 items-center justify-between">
            ...
            <div className="flex gap-4 items-center justify-between">
                <select name="idioma" className="text-primary bg-white text-xs font-medium pl-2 pr-4 py-1 w-32 h-9 rounded-lg          border-primary border shadow focus:outline-none cursor-pointer">
