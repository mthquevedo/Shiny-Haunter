    ...
    return (
        <main className="flex items-center justify-center bg-gradient-to-br from-indigo-600 to-primary w-100v h-100v overflow-hidden">
            <section className="flex flex-col items-center justify-center gap-4 w-[80%]">
                <img className="h-auto w-[90%] md:w-[60%] lg:w-[25%]" src="/assets/Gengar loading.gif" alt="Animação de carregamento da página" />
                ...
                <Progress.Root className="h-6 xsm:h-7 md:h-9 lg:h-7 w-full md:w-[90%] lg:w-[75%] xl:w-[70%] 2xl:w-[50%] bg-slate-900 border-2 border-primary overflow-hidden rounded-full" value={progress}>
