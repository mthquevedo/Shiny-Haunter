...
export function CatchButton({ pokemon }: CatchButtonProps) {
    ...
    return (
        <CardTooltip content="Capturar" side="top">
            <button
                className={cn("flex justify-center items-center text-neutral-700 bg-neutral-300 rounded-lg shadow-sm p-1 2xl:p-1.5 md:hover:bg-red-500 md:hover:text-white md:active:scale-95 transition", { [ACTIVE_BUTTON]: isCatched })}
