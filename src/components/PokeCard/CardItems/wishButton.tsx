...
export function WishButton({ pokemon }: WishButtonProps) {
    ...
    return (
        <>
            <button
                className={cn("flex justify-center w-[6.4rem] xsm:w-[7.2rem] xsx:w-[8.8rem] md:w-[7.4rem] lg:w-[4.7rem] xl:w-[7rem] 2xl:w-full items-center text-xs lg:text-[0.625rem] 2xl:text-xs text-white font-medium bg-blue-500 rounded-lg p-1 xsm:py-1.5 lg:py-1 2xl:py-1.5 hover:bg-blue-400 md:hover:shadow-sm active:bg-blue-600 active:scale-[0.98] transition", { [ACTIVE_BUTTON]: isWished })}
