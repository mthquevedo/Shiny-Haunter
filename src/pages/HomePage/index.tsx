...
export function HomePage() {
    ...
    return (
        <section className="w-full h-[95%]">
            <HiddenScrollBar>
                <section className="flex flex-col items-center justify-start gap-3 xsm:gap-8 md:gap-8 lg:gap-7 2xl:gap-10 size-full">
                    <HeroBanner />

                    <section className="flex flex-col w-full h-[56%] 2xl:justify-between lg:flex-row gap-3 xsm:gap-8 md:gap-8 lg:gap-10">
                        <LastPokemonBoard
                            list={lastWished}
